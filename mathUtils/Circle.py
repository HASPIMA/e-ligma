...
class Circle:
    ...
    def __contains__(self, other):
        return self.contains(other.x+other.radius,other.y) and self.contains(other.x-other.radius,other.y) and self.contains(other.x,other.y+other.radius) and self.contains(other.x,other.y-other.radius)
    ...
    def overlaps(self, other):
        return self.contains(other.x + other.radius, other.y) or self.contains(other.x - other.radius,other.y) or self.contains(other.x,other.y + other.radius) or self.contains(other.x, other.y - other.radius)
